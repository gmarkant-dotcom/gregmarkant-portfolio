const TICKER_SEGMENTS = [
  'Greg Markant',
  '16 years translating C-suite ambition into programs that drive KPIs, unlock revenue, and make teams indispensable',
  'Two fierce daughters',
  'Fortune 500 clients across tech, CPG, retail, banking, pharma, and beyond',
  'Tennis is life',
